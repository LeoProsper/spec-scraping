...
import { Star, MapPin, Phone, Globe, Eye, MessageSquare, ArrowUpDown } from 'lucide-react';
import {
  Table,
  TableBody,
  TableCell,
    ...
    return (
      <div className="p-6">
        <div className="text-center py-12 border-2 border-dashed rounded-lg">
          ...
          <h3 className="text-lg font-semibold mb-2">Nenhuma empresa ainda</h3>
          <p className="text-sm text-muted-foreground">
            Adicione empresas a esta lista para começar
          </p>
        </div>
      </div>
    );
