            ...
            <div className="w-full pt-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                {displayedHistory.map((item) => (
                  <Card 
                    key={item.id} 
                    className="group relative overflow-hidden hover:border-primary/50 hover:shadow-lg transition-all duration-300 bg-gradient-to-r from-background to-muted/20 aspect-[16/6]"
                  >
                      ...
                      <div className="flex flex-col h-full justify-between gap-3">
                        ...
                        <div className="flex items-start justify-between">
                          ...
                          <Button 
                            size="sm" 
                            variant="ghost" 
                            className="h-7 w-7 p-0 opacity-0 group-hover:opacity-100 transition-opacity -mt-1 -mr-1"
                            onClick={async (e) => {
                              e.stopPropagation();
