            ...
            <div className="flex flex-col items-center space-y-8 text-center">
              ...
              <div className="space-y-4">
                <h1 className="font-heading text-5xl font-bold tracking-tight sm:text-6xl lg:text-7xl">
                  <span className="block">Gerador de Oportunidades</span>
                  <span className="block">para seu próximo cliente</span>
                </h1>
                <p className="mx-auto max-w-2xl text-lg text-muted-foreground sm:text-xl">
                  Gere prompts estratégicos de prospecção usando IA para descobrir
                  empresas com dores específicas. Prospecte de forma inteligente.
                </p>
              </div>
            </div>
          </div>

          {/* Card Principal com Seletor e Resultado */}
          <Card>
            <CardHeader>
              <CardTitle>Gerador de Oportunidades B2B</CardTitle>
              <CardDescription>
                Selecione um nicho e gere prompts estratégicos de prospecção usando IA
              </CardDescription>
            </CardHeader>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-3">
                <h3 className="text-sm font-medium">Selecione o Nicho</h3>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between gap-4 p-4 bg-muted/30 rounded-lg border min-h-[100px]">
                  {currentPrompt ? (
                    <>
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
                    <CardTitle>Histórico de Resultados</CardTitle>
                    <CardDescription>
                      Suas últimas frases geradas ({history.length} total)
                    </CardDescription>
                  </div>
                  {history.length > 9 && (
                    <Button
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {displayedHistory.map((item) => (
                    <Card 
                      key={item.id} 
                      className="group relative overflow-hidden hover:border-primary/50 transition-all duration-200"
                    >
