  ...
  return (
    <>
      <PageHeader
        ...
        description="Amplie seu radar, descubra potenciais clientes e negocios."
      />
      <PageBody>
              ...
              <div className="flex flex-col items-center gap-2">
                <div className="inline-flex items-center gap-2 rounded-full border bg-background px-4 py-2 text-sm">
                  ...
                  <span className="text-muted-foreground">
                    Buscador de Oportunidades com IA
                  </span>
                </div>
              </div>
                ...
                <div className="text-center space-y-2">
                  <h2 className="text-2xl font-bold tracking-tight">
                    ...
                    <span className="text-muted-foreground text-sm font-normal block mt-1">
                      Escolha a categoria que melhor se encaixa no seu público-alvo
                    </span>
                  </h2>
                </div>
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {displayedHistory.map((item) => (
                    <div key={item.id} className="group [perspective:1000px] h-[280px]">
                      <div className="relative w-full h-full transition-transform duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                        {/* Front Side - Card Original */}
                        <Card className="absolute inset-0 border-primary/10 hover:border-primary/50 transition-all duration-200 [backface-visibility:hidden]">
                          <CardHeader>
                        ...
                        {/* Back Side - Possíveis Serviços */}
                        <Card className="absolute inset-0 border-primary/10 [transform:rotateY(180deg)] [backface-visibility:hidden]">
                          <CardHeader>
                            <div className="flex items-start justify-between gap-2">
                              <Badge variant="secondary" className="text-xs">
                                Possíveis Serviços
                          ...
                          <CardContent className="space-y-3 h-[calc(100%-80px)] overflow-auto">
                            <p className="text-xs font-medium text-foreground mb-2">
                              Soluções para esta dor:
                            </p>
                            <ul className="space-y-2 text-xs text-muted-foreground">
                              <li className="flex items-start gap-2">
                                <span className="text-primary mt-0.5">•</span>
                                <span>Desenvolvimento de dashboard personalizado de KPIs comerciais</span>
                              </li>
                              <li className="flex items-start gap-2">
                                <span className="text-primary mt-0.5">•</span>
                                <span>Integração com CRM e sistemas de vendas existentes</span>
                              </li>
                              <li className="flex items-start gap-2">
                                <span className="text-primary mt-0.5">•</span>
                                <span>Consultoria em processos comerciais e métricas estratégicas</span>
                              </li>
                              <li className="flex items-start gap-2">
                                <span className="text-primary mt-0.5">•</span>
                                <span>Automação de relatórios gerenciais em tempo real</span>
                              </li>
                              <li className="flex items-start gap-2">
                                <span className="text-primary mt-0.5">•</span>
                                <span>Treinamento de equipes para análise de dados comerciais</span>
                              </li>
                            </ul>
                          </CardContent>
                        </Card>
