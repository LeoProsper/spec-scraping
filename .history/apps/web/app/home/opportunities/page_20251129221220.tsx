                    ...
                    <div key={item.id} className="[perspective:1000px]">
                      ...
                      >
                        ...
                        <Card className="absolute inset-0 border-primary/10 [transform:rotateY(180deg)] [backface-visibility:hidden] flex flex-col">
                          ...
                          <CardContent className="flex-1 overflow-y-auto space-y-2 scrollbar-thin scrollbar-thumb-border scrollbar-track-transparent hover:scrollbar-thumb-muted-foreground/20">
                            ...
                            <ul className="space-y-1.5 text-xs text-muted-foreground pr-2">
                              <li className="flex items-start gap-1.5">
                                ...
                                <span>Dashboard de KPIs comerciais</span>
                              </li>
                              <li className="flex items-start gap-1.5">
                                <span className="text-primary mt-0.5 flex-shrink-0">•</span>
                                <span>Integração CRM e vendas</span>
                              </li>
                              <li className="flex items-start gap-1.5">
                                <span className="text-primary mt-0.5 flex-shrink-0">•</span>
                                <span>Consultoria em métricas</span>
                              </li>
                              <li className="flex items-start gap-1.5">
                                <span className="text-primary mt-0.5 flex-shrink-0">•</span>
