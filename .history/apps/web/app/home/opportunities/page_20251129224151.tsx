                    ...
                    <div key={item.id} className="[perspective:1000px]">
                      ...
                      >
                        ...
                        <Card className="absolute inset-0 border-primary/10 [transform:rotateY(180deg)] [backface-visibility:hidden] flex flex-col">
                          ...
                          <CardContent className="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-border scrollbar-track-transparent hover:scrollbar-thumb-muted-foreground/20 px-8 pt-4 pb-6">
