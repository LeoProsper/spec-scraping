                      ...
                      >
                        ...
                        <Card className="absolute inset-0 border-primary/10 [transform:rotateY(180deg)] [backface-visibility:hidden]">
                          <div className="relative h-full flex flex-col">
                            {/* Button com z-index baixo */}
                            <CardHeader className="absolute top-0 right-0 z-0 pb-3">
                            ...
                            <CardContent className="relative z-10 h-full overflow-y-auto scrollbar-thin scrollbar-thumb-border scrollbar-track-transparent hover:scrollbar-thumb-muted-foreground/20 px-8 pt-4 pb-6">
