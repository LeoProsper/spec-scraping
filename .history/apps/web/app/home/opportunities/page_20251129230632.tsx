                  ...
                  {displayedHistory.map((item) => (
                    <div key={item.id} className="[perspective:1000px]">
                      ...
                      >
                        ...
                        <Card className="border-primary/10 hover:border-primary/50 transition-all duration-200 [backface-visibility:hidden]">
                          <CardHeader>
                        ...
                        <Card className="absolute inset-0 border-primary/10 [transform:rotateY(180deg)] [backface-visibility:hidden]">
                          <div className="relative h-full flex items-center justify-center">
                            {/* Button fixo no topo com z-index alto */}
                            <div className="absolute top-0 right-0 z-20 p-6 pb-3">
                              <Button 
                                size="sm" 
                                variant="ghost" 
                            ...
                            <div className="w-full h-full overflow-y-auto scrollbar-thin scrollbar-thumb-border scrollbar-track-transparent hover:scrollbar-thumb-muted-foreground/20 px-8 py-6 flex items-center">
                              <div className="w-full space-y-4">
                                <div>
                                  ...
                                  <p className="text-sm text-muted-foreground leading-relaxed">
                                    Dashboard de KPIs comerciais • Integração CRM e vendas • Consultoria em métricas • Automação de relatórios • Treinamento de equipes
                                  </p>
                                </div>
                              </div>
                            </div>
