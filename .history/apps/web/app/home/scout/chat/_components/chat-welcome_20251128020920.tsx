...
export function ChatWelcome() {
  ...
  useEffect(() => {
    // Reset states when searchId changes
    ...
    // Load search if we have a searchId and haven't loaded this one yet
    if (searchIdParam && searchIdParam !== loadedSearchIdRef.current && !isSearching) {
