              ...
              <div className="space-y-6">
                ...
                {place.link && (
                  <div className="flex flex-col gap-2">
                    ...
                    <button className="text-sm text-muted-foreground hover:text-primary inline-flex items-center gap-2 transition-colors text-left">
                ...
                {place.rating && place.reviews_count && place.top_reviews && place.top_reviews.length > 0 && (
                  <div className="mt-6 pt-6 border-t border-border">
                    ...
                    <div className="mb-6">
                      ...
                      <div className="space-y-2">
                        {[5, 4, 3, 2, 1].map((stars) => {
                          const percentage = stars === Math.round(place.rating || 0) 
                            ? 60 
                            : stars === Math.round(place.rating || 0) - 1 
                            ? 25 
                            : stars === Math.round(place.rating || 0) + 1 
                            ? 10 
                            : 5;
                          ...
                          return (
                            <div key={stars} className="flex items-center gap-2">
                              <span className="text-xs w-2 shrink-0">{stars}</span>
                    ...
                    <div className="mb-6">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {(() => {
                          ...
                          const stopWords = ['o', 'a', 'de', 'da', 'do', 'e', 'é', 'em', 'para', 'com', 'um', 'uma', 'os', 'as', 'dos', 'das', 'no', 'na', 'que', 'se', 'por'];
