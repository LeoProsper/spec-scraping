          ...
          <div className="px-6 pb-6 pt-2 bg-muted/10">
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="space-y-6">
                ...
                {place.rating && place.reviews_count && (
                  <div className="border-t border-border pt-6 mt-6">
                    <div className="flex items-center justify-between mb-4">
                      <h4 className="text-base font-medium">Resumo das avaliações do Google</h4>
                    ...
                    <div className="flex items-center justify-end gap-4 mb-6">
                      ...
                      <div className="text-5xl font-medium">{place.rating?.toFixed(1)}</div>
                    </div>
                  </div>
                )}
                ...
                {place.top_reviews && place.top_reviews.length > 0 && (
                  <div className="border-t border-border pt-6 mt-6">
                    <h4 className="text-base font-medium mb-4">Avaliações</h4>

                    {/* FILTROS DE AVALIAÇÃO */}
                    <div className="flex items-center gap-2 mb-4 flex-wrap">
                      <button className="px-4 py-1.5 rounded-full text-sm bg-primary text-primary-foreground font-medium">
                        ✓ Tudo
                      </button>
                      <button className="px-3 py-1.5 rounded-full text-sm bg-muted hover:bg-muted/80 transition-colors">
                        cantina 312
                      </button>
                      <button className="px-3 py-1.5 rounded-full text-sm bg-muted hover:bg-muted/80 transition-colors">
                        gosto 139
