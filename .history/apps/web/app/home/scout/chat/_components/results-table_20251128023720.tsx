          ...
          <div className="px-6 pb-6 pt-2 bg-muted/10">
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="space-y-6">
                ...
                {/* EMPRESA LGBTQ+ */}
                {place.about && (
                  typeof place.about === 'string' 
                    ? place.about.toLowerCase().includes('lgbtq')
                    : Array.isArray(place.about) && place.about.some(item => 
                        typeof item === 'string' && item.toLowerCase().includes('lgbtq')
                      )
                ) && (
                  <div className="flex items-center gap-3 text-sm">
...
export function ResultsTable({ results, onNewSearch }: ResultsTableProps) {
  ...
  console.log('📋 Primeiro resultado:', results[0] ? {
    ...
    has_rating_distribution: !!results[0].rating_distribution
  } : 'nenhum');
