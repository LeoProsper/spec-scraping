...
BEGIN
  ...
  -- 2) Verificar se empresa já existe por place_id + responsavel_id
  ...
  ELSE
    ...
    VALUES (
      ...
      v_extracted_state,     -- Estado extraído (renomeado para 'uf')
      p_category,
      p_phone,
      p_website,
      p_rating,
      p_reviews_count,       -- Campo é 'total_reviews' na tabela
      p_latitude,
      p_longitude,
      p_google_maps_link,
      p_cnpj,
