...
export interface GoogleMapsPlace {
  ...
  // Dados da Receita Federal (enriquecimento via API)
  razao_social?: string; // Razão social cadastrada na Receita
  nome_fantasia?: string; // Nome fantasia
  situacao_cadastral?: string; // Ativa, Baixada, Suspensa, etc
  data_situacao_cadastral?: string; // Data da situação (YYYY-MM-DD)
  ...
  cnaes_secundarios?: string[]; // Códigos CNAE secundários
  capital_social?: string; // Valor do capital social
  opcao_simples?: string; // Optante Simples Nacional (S/N)
  ...
  receita_logradouro?: string; // Endereço da Receita
  ...
  receita_uf?: string;
  receita_email?: string; // Email cadastrado na Receita
  receita_telefones?: Array<{ // Telefones da Receita
    ddd: string;
    numero: string;
    is_fax: boolean;
  }>;
  receita_fetched_at?: string; // Data do enriquecimento
...
export interface Company {
  ...
  receita_municipio?: string;
  receita_uf?: string;
  receita_email?: string;
  receita_telefones?: Array<{
    ddd: string;
    numero: string;
    is_fax: boolean;
  }>;
  receita_fetched_at?: string;
