...
export function PageDescription(props: React.PropsWithChildren) {
  return (
    <span className={'text-muted-foreground text-xs leading-none font-normal inline-flex items-center'}>
      {props.children}
    </span>
  );
}
  ...
  return (
    ...
    >
      <div className="flex items-center gap-x-2.5">
        ...
        <If condition={displaySidebarTrigger && (title || description)}>
          <Separator
            orientation="vertical"
            className="hidden h-4 w-px lg:inline-flex"
          />
        </If>
