            ...
            <Container key={`collapsible-${index}`}>
              <SidebarGroup key={item.label}>
                <If
                  ...
                  fallback={
                    <SidebarGroupLabel className={cn({ 'hidden': !open, '-mb-6': index === 0 && open })}>
                      <Trans i18nKey={item.label} defaults={item.label} />
                    </SidebarGroupLabel>
                  }
                >
                  <SidebarGroupLabel className={cn({ 'hidden': !open, '-mb-6': index === 0 && open })} asChild>
                    <CollapsibleTrigger>
                      <Trans i18nKey={item.label} defaults={item.label} />
                ...
                <SidebarGroupContent className={cn({ '-mt-4': index === 0 })}>
                  <SidebarMenu>
                    <ContentContainer>
